...
async function main() {
  ...
  const projects = [
    {
      ...
      description:
        "Sitio web de portafolio personal con panel de administración, animaciones avanzadas y diseño responsive. Construido con Next.js y Prisma.",
      tags: JSON.stringify(["Next.js", "TypeScript", "Prisma", "Tailwind"]),
      category: "Frontend",
      featured: true,
      order: 1,
    },
    ...
    },
    {
      ...
      description:
        "API completa con autenticación JWT, CRUD, paginación y documentación. Desarrollada en el ecosistema JavaScript/TypeScript con PostgreSQL.",
      tags: JSON.stringify(["Node.js", "TypeScript", "PostgreSQL", "JWT"]),
      category: "Backend",
      featured: true,
      order: 3,
    },
  ...
  const existingCert = await prisma.certificate.findFirst({
    where: { title: "Ingeniería en Informática" },
  });
  if (!existingCert) {
